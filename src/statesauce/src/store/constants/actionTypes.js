...
export const INIT_SECOND_CONTRACT_REQUEST = 'INIT_SECOND_CONTRACT_REQUEST'
export const INIT_SECOND_CONTRACT_FAILURE = 'INIT_SECOND_CONTRACT_FAILURE'
export const INIT_SECOND_CONTRACT_SUCCESS = 'INIT_SECOND_CONTRACT_SUCCESS'
